...
- **The analysis engine is deterministic by design** (see `docs/PHASE0_1_PLAN.md` §5.5). Tests assert exact classifications and exposure math; LLM output is schema-validated and not unit-tested directly.
